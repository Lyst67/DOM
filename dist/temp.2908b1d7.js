...
function createCard({ name, main: { temp, feels_like }, clouds: { all }, sys: { sunrise, sunset }, weather: [{ description, icon, main }] }) {
    ...
    const weatherData = `<h2 class="city-name">${name}</h2>
          <img src="${icon}" alt="${main}" class="icon">
...
//# sourceMappingURL=temp.2908b1d7.js.map
