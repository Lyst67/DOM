...
})({"gQUUy":[function(require,module,exports) {
...
var _unsplashApi = require("./unsplash_api");
...
const handleSearchSubmit = (evt)=>{
    ...
    unsplashApi.fetchPhotos().then(({ data })=>{
        ...
        data.total_pages <= 1 ? loadBtnEl.classList.add("is-hidden") : loadBtnEl.classList.remove("is-hidden");
    }).catch(console.warn);
};
const handleMoreImg = ()=>{
    unsplashApi.page += 1;
    unsplashApi.fetchPhotos().then(({ data })=>{
        ...
        const searchResult = data.results;
        if (unsplashApi.page >= data.total_pages) loadBtnEl.classList.add("is-hidden");
...
function createMarkupImg(arr) {
    return arr.map(({ urls, alt_description })=>`<li class="gallery__item"><img src="${urls.small}" alt="${alt_description}" class="gallery-img"></li>`).join("");
}

},{"axios":"jo6P5","./unsplash_api":"43WJS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"43WJS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class UnsplashAPI {
    ...
    query = null;
    fetchPhotos() {
        return (0, _axiosDefault.default).get(`${this.#BASE_URL}/search/photos`, {
            params: {
                per_page: 12,
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gQUUy","iXSQ6"], "iXSQ6", "parcelRequire352e")
